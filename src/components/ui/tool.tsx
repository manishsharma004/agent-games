    ...
    >
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        <CollapsibleTrigger asChild>
          <Button
            variant="ghost"
            className="pk-tool-trigger bg-background h-auto w-full justify-between rounded-b-none px-3 py-2 font-normal"
          >
            <div className="flex items-center gap-2">
              {getStateIcon()}
              <span className="pk-tool-name font-mono text-sm font-medium">
                {toolPart.type}
              </span>
              <span className="pk-tool-state">{getStateBadge()}</span>
            </div>
